...
macro(xgboost_target_defs target)
  ...
  if(USE_VEC_MATH_LIB)
    target_compile_definitions(${target} PRIVATE -DXGBOOST_USE_VEC_MATH_LIB=1)
    if(USE_VEC_MATH_LIB STREQUAL "SLEEF")
      target_compile_definitions(${target} PRIVATE -DXGBOOST_USE_SLEEF=1)
    elseif(USE_VEC_MATH_LIB STREQUAL "ARMPL")
      target_compile_definitions(${target} PRIVATE -DXGBOOST_USE_ARMPL=1)
    endif()
  endif()
endmacro()
...
macro(xgboost_target_link_libraries target)
  ...
  if(USE_VEC_MATH_LIB)
    if(USE_VEC_MATH_LIB STREQUAL "SLEEF")
      target_link_libraries(${target} PRIVATE SLEEF::sleef)
    elseif(USE_VEC_MATH_LIB STREQUAL "ARMPL")
      target_link_libraries(${target} PRIVATE ArmPL::armpl)
    endif()
  endif()
endmacro()
