...
test_that("Models from previous versions of XGBoost can be loaded", {
  ...
  lapply(list.files(model_dir), function (x) {
    ...
    if (is_rds && compareVersion(model_xgb_ver, '1.1.1.1') >= 0) {
      ...
      print(cpp_warning)
      m <- grepl(paste0('.*The model was generated by older version of XGBoost \\([0-9\\.]+\\), whereas you are ',
                        'currently using XGBoost version [0-9\\.]+\\. Consider saving the model again for ',
