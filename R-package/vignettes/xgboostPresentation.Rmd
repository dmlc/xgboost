...
It has been [used](https://github.com/dmlc/xgboost) to win several [Kaggle](https://www.kaggle.com) competitions.
...
> In the real world, it would be up to you to make this division between `train` and `test` data. The way to do it is out of the purpose of this article, however `caret` package may [help](https://topepo.github.io/caret/data-splitting.html).
...
If with your own dataset you have not such results, you should think about how you divided your dataset in training and test. May be there is something to fix. Again, `caret` package may [help](https://topepo.github.io/caret/data-splitting.html).
