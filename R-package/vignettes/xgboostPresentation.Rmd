...
For the development version, see the [GitHub page](https://github.com/dmlc/xgboost) and the [installation docs](https://xgboost.readthedocs.io/en/latest/install.html) for further instructions.
...
##### Evals and verbose options

**XGBoost** has several features to help you to view how the learning progress internally - and what's more,
it also supports passing . The purpose is to help you to set the best parameters, which is the key of your model quality.
