...
#'   \item \code{interaction_constraints} A list of character vectors specifying column names for interaction constraints - each item of the list represents the columns of one permissible interaction.  Leave unspecified for no interaction constraints.
#' }
#' 
