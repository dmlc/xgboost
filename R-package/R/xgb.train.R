...
#'   \item \code{int_constraints_list} A list of character vectors specifying column names for interaction constraints.
#'   \item \code{int_constraints_flag} Boolean specifying whether to enforce interaction constraints in int_constraints_list.
#' }
#' 
