...
## Worktree hygiene
- [ ] Tracked modifications in `.bot/memory/coordinator_retrieved_memory.md` are restored
- [ ] Tracked modifications in `.bot/memory/worker_retrieved_memory.md` are restored
- [ ] Tracked modifications in `.bot/retrieved_memory.md` are restored
- [ ] Untracked local coordination/workspace files may remain untracked, but are not part of the branch diff

## Product patch discipline
- [ ] Remediation work stays within the intended three product files unless a reproduced failing check proves otherwise
...
- [ ] Worker can summarize both remediation tracks separately: branch-diff cleanup and any actual product fix
