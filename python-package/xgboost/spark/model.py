...
class SparkXGBModelWriter(MLWriter):
    ...
    def saveImpl(self, path):
        ...
        # The json file written by Spark based on model string generated by
        # booster.save_raw("json").decode("utf-8") can't be loaded by XGBoost directly.
        _get_spark_session().read.json(xgb_model_file).write.json(model_save_path)
