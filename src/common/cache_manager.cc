...
void GetCacheInfo(int cache_num, int * type, int * level, int64_t * sets, int * line_size, int * partitions, int * ways) {
...
void DetectDataCaches(int cache_sizes_len, int64_t* cache_sizes) {
