 ...
 * |--------------------+----------+-----------+-------------+-------------+------------------------|
 * | num_row            | kUInt64  | True      | NA          |          NA | ${num_row_} | | num_col
 * | kUInt64  | True      | NA          |          NA | ${num_col_}            | | num_nonzero |
 * kUInt64  | True      | NA          |          NA | ${num_nonzero_}        | | labels | kFloat32 |
 * False     | ${size}     |           1 | ${labels_}             | | group_ptr          | kUInt32
 * | False     | ${size}     |           1 | ${group_ptr_}          | | weights            |
 * kFloat32 | False     | ${size}     |           1 | ${weights_}            | | base_margin |
 * kFloat32 | False     | ${Shape(0)} | ${Shape(1)} | ${base_margin_}        | | labels_lower_bound
 * | kFloat32 | False     | ${size}     |           1 | ${labels_lower_bound_} | |
