...
// Utility for manipulating the node index. A row is invalid if it's not used in the last
// iteration (due to sampling). For these rows, the corresponding tree node index is negated.
