 ...
 public:
  ...
  void LoadConfig(Json const& in) override {
    ...
    if (!Version::Same(origin_version)) {
      LOG(WARNING) << "The model was generated by older version of XGBoost ("
                   << Version::String(origin_version)
                   << "), whereas you are currently using XGBoost version "
                   << Version::String(Version::Self()) << ". Consider saving the model "
