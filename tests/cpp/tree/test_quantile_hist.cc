...
namespace tree {
    ...
    public:
      ...
      void TestBuildHist(int nid,
        ...
        std::vector<GradientPairPrecise> solution{
            GradientPairPrecise(0.27f, 0.29f), GradientPairPrecise(0.27f, 0.29f),
            GradientPairPrecise(0.47f, 0.49f), GradientPairPrecise(0.27f, 0.29f),
            GradientPairPrecise(0.57f, 0.59f), GradientPairPrecise(0.26f, 0.27f),
            GradientPairPrecise(0.37f, 0.39f), GradientPairPrecise(0.23f, 0.24f),
            GradientPairPrecise(0.37f, 0.39f), GradientPairPrecise(0.27f, 0.28f),
            GradientPairPrecise(0.27f, 0.29f), GradientPairPrecise(0.37f, 0.39f),
            GradientPairPrecise(0.26f, 0.27f), GradientPairPrecise(0.23f, 0.24f),
            GradientPairPrecise(0.57f, 0.59f), GradientPairPrecise(0.47f, 0.49f),
            GradientPairPrecise(0.47f, 0.49f), GradientPairPrecise(0.37f, 0.39f),
            GradientPairPrecise(0.26f, 0.27f), GradientPairPrecise(0.23f, 0.24f),
            GradientPairPrecise(0.27f, 0.28f), GradientPairPrecise(0.57f, 0.59f),
            GradientPairPrecise(0.23f, 0.24f), GradientPairPrecise(0.47f, 0.49)};
      ...
      void TestEvaluateSplit(const GHistIndexBlockMatrix& quantile_index_block,
        ...
        std::vector<GradientPair> row_gpairs = {
            GradientPair(0.23f, 0.24f), GradientPair(0.24f, 0.25f),
            GradientPair(0.26f, 0.27f), GradientPair(0.27f, 0.28f),
            GradientPair(0.27f, 0.29f), GradientPair(0.37f, 0.39f),
            GradientPair(0.47f, 0.49f), GradientPair(0.57f, 0.59f)};
  ...
  public:
    ...
    void TestInitData() {
      ...
      std::vector<GradientPair> gpair = {
          GradientPair(0.23f, 0.24f), GradientPair(0.23f, 0.24f),
          GradientPair(0.23f, 0.24f), GradientPair(0.23f, 0.24f),
          GradientPair(0.27f, 0.29f), GradientPair(0.27f, 0.29f),
          GradientPair(0.27f, 0.29f), GradientPair(0.27f, 0.29f)};
