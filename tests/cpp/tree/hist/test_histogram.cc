...
void TestAddHistRows(bool is_distributed) {
  ...
  nodes_for_explicit_hist_build_.emplace_back(3, tree.GetDepth(3), 0ul);
  nodes_for_explicit_hist_build_.emplace_back(4, tree.GetDepth(4), 0ul);
  nodes_for_subtraction_trick_.emplace_back(5, tree.GetDepth(5), 0ul);
  nodes_for_subtraction_trick_.emplace_back(6, tree.GetDepth(6), 0ul);
...
void TestSyncHist(bool is_distributed) {
  ...
  // level 0
  nodes_for_explicit_hist_build_.emplace_back(0, tree.GetDepth(0), 0ul);
  ...
  // level 1
  nodes_for_explicit_hist_build_.emplace_back(tree[0].LeftChild(), tree.GetDepth(1), 0ul);
  nodes_for_subtraction_trick_.emplace_back(tree[0].RightChild(), tree.GetDepth(2), 0ul);
  ...
  // level 2
  nodes_for_explicit_hist_build_.emplace_back(3, tree.GetDepth(3), 0ul);
  nodes_for_subtraction_trick_.emplace_back(4, tree.GetDepth(4), 0ul);
  nodes_for_explicit_hist_build_.emplace_back(5, tree.GetDepth(5), 0ul);
  nodes_for_subtraction_trick_.emplace_back(6, tree.GetDepth(6), 0ul);
...
void TestBuildHistogram(bool is_distributed) {
  ...
  CPUExpandEntry node(RegTree::kRoot, tree.GetDepth(0), 0, {});
...
void TestHistogramCategorical(size_t n_categories) {
  ...
  RegTree tree;
  CPUExpandEntry node(RegTree::kRoot, tree.GetDepth(0), kRows);
  std::vector<CPUExpandEntry> nodes_for_explicit_hist_build;
  nodes_for_explicit_hist_build.push_back(node);
...
void TestHistogramExternalMemory(BatchParam batch_param, bool is_approx) {
  ...
  nodes.emplace_back(0, tree.GetDepth(0), 0ul);
