...
TEST(GpuHist, EvaluateSingleSplitEmpty) {
  ...
  EvaluateSingleSplit(dh::ToSpan(out_split), EvaluateSplitInputs<GradientPair>{});
...
TEST(GpuHist, EvaluateSplits) {
  ...
  thrust::device_vector<int> monotonic_constraints(feature_set.size(), 0);
  EvaluateSplitInputs<GradientPair> input_left{1,
                                         parent_sum,
                                         param,
                                         dh::ToSpan(feature_set),
                                         dh::ToSpan(feature_segments),
                                         ...
                                         ValueConstraint(),
                                         dh::ToSpan(monotonic_constraints)};
  EvaluateSplitInputs<GradientPair> input_right{2,
                                         parent_sum,
                                         param,
                                         dh::ToSpan(feature_set),
                                         dh::ToSpan(feature_segments),
