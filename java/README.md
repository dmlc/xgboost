 ...
 * right click on project name -> choose "Properties" -> click on "C/C++" in the window -> change the "Additional Include Directories" to fit your jdk install path.
 * rebuild all
 * move the dll "xgboostjavawrapper.dll" to "xgboost4j/src/main/resources/lib/"

for linux: 
 * modify the "export JAVAINCFLAGS" line in Makefile to fit your environment
 * run "create_wrap.sh"