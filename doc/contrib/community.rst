...
---------------------------
Everyone in the community is welcome to send patches, documents, and propose new directions to the project. The key guideline here is to enable everyone in the community to get involved and participate in decision-making and development. When major changes are proposed, an RFC should be sent to allow discussion by the community. We encourage public discussion through archivable channels such as GitHub issues and GitHub Discussions, so that everyone in the community can participate and review the process later.
...
- Community involvement: active participation in `GitHub Discussions <https://github.com/dmlc/xgboost/discussions>`_, promote the projects via tutorials, talks and outreach. We encourage committers to collaborate broadly, e.g. do code reviews and discuss designs with community members that they do not interact physically.
