...
In addition, the old page-concat option for GPU external memory has been removed. XGBoost
will use the full dataset for training. (#11882, #11897)
...
- Reduced gradient (sketch boost) for the hist tree method, which avoids materializing the
  full gradient matrix and improves scalability with the number of targets. Users can
  use a custom objective to define the tree split gradient in addition to the full leaf
  gradient.
...
- Compatibility fixes for the latest RMM (25.12 and 26.02) and CCCL (thrust 3.3). (#11930,
  #11834, #11871, #11861, #11785) A nightly CI pipeline was added to test XGBoost with the
  latest CCCL and RMM. (#11863)
...
- Support pre-commit for various linting and formatting tasks. ``clang-format`` is now
  required by the CI. (#11984, #11978, #11980, #11958, #11953, #11946)
...
- Various dependency updates, fixes, test refactoring, and cleanups. (#11955, #11957,
  ...
  #11705, #11699, #11832, #11796, #11828, #11852, #11800)
