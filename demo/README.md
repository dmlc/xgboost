...
- Chris Deotte, 1st place winner of [Kaggle Playground Series - Season 5, Episode 2 (Backpack Price Prediction)](https://www.kaggle.com/competitions/playground-series-s5e2). Link to [discussion](https://www.kaggle.com/competitions/playground-series-s5e2/discussion/551152), [code](https://github.com/NVIDIA/rapids-notebooks/blob/branch-25.02/competition_notebooks/kaggle/Backpack_Price_Prediction/Backpack_Price_Prediction.ipynb) and [summary article](https://developer.nvidia.com/blog/grandmaster-pro-tip-winning-first-place-in-kaggle-competition-with-feature-engineering-using-nvidia-cudf-pandas/)
- Benedikt Schifferer, Alexey Vagizov, Sergey Ivanov and Roman Levkovich, 1st place winners of [RecSys Challenge 2021](https://recsys-twitter.com/). Link to [winning solution](https://medium.com/nvidia-merlin/winning-the-recsys2021-challenge-by-a-diverse-set-of-xgboost-and-neural-network-models-4c5422a642d8)
