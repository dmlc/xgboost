...
- minerppdy, 1st place winner of [CIBMTR - Equity in post-HCT Survival Predictions](https://www.kaggle.com/competitions/equity-post-HCT-survival-predictions) ($50K prize). Multi-target ensemble using XGBoost Survival Embeddings. Link to [writeup](https://www.kaggle.com/competitions/equity-post-HCT-survival-predictions/writeups/minerppdy-1st-place-solution-2-targets-and-ensembl).
- Tilii, 1st place winner of [Kaggle Playground Series S5E10 - Predicting Road Accident Risk](https://www.kaggle.com/competitions/playground-series-s5e10) (Oct 2025). Ensemble including XGBoost and CatBoost with genetic programming features. Link to [writeup](https://www.kaggle.com/competitions/playground-series-s5e10/writeups/1st-place-i-think-it-was-genetic-programming).
