...
- Chris Deotte, 1st place winner of [Kaggle Playground Series S4E7 - Binary Classification with Bank Churn](https://www.kaggle.com/competitions/playground-series-s4e7) (Jul 2024). A single XGBoost model with extensive feature engineering achieved the winning score on the private leaderboard. Link to [discussion](https://www.kaggle.com/competitions/playground-series-s4e7/discussion/523270).
- Kazuki Onodera, 1st place winner of [Kaggle Playground Series S6E4 - Multiclass Classification](https://www.kaggle.com/competitions/playground-series-s6e4) (Apr 2026). Ensemble featuring 17 tuned XGBoost models across one-vs-rest and multiclass objectives. Link to [writeup](https://www.kaggle.com/competitions/playground-series-s6e4/discussion/574219).
