 ...
 * \file updater_quantile_hist_sycl.h
 */
 ...
 protected:
  ...
  struct Builder {
   public:
    ...
    inline void SubtractionTrick(GHistRowSycl self, GHistRowSycl sibling, GHistRowSycl parent) {
   ...
   protected:
    ...
    common::ParallelGHistBuilderSycl hist_buffer_;
