...
class XGBoostJNI {
  ...
  public final static native int XGBoosterPredictFromDMatrix(long handle, long dmat, String config,
                                                             float[][] predicts);

  public final static native int XGBoosterTestMethod(String config);
