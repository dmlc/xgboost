...
public class Booster implements Serializable, KryoSerializable {
   ...
   * @return predict results
   */
  public float[][] predictFromDMatrix(DMatrix data, final String config) throws XGBoostError {
  ...
  public float[][] predictFromDMatrix(DMatrix data) throws XGBoostError {
    final String config = "{\"training\": false, \"type\": 0, " +
      "\"iteration_begin\": 0, \"iteration_end\": 0, \"strict_shape\": false}";

    return predictFromDMatrix(data, config);
  }

  public void testMethod() throws XGBoostError {
    final String config = "{\"training\": false, \"type\": 0, " +
      "\"iteration_begin\": 0, \"iteration_end\": 0, \"strict_shape\": true}";

    XGBoostJNI.checkCall(XGBoostJNI.XGBoosterTestMethod(config));
  }
